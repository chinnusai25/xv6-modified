...
int main(){ 
   ...
   f:	53                   	push   %ebx
  10:	51                   	push   %ecx
  11:	bb 19 00 00 00       	mov    $0x19,%ebx
  16:	83 ec 18             	sub    $0x18,%esp
  19:	eb 0a                	jmp    25 <main+0x25>
  1b:	90                   	nop
  1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 int pid[25];
    for(int i=0;i<25;i++) {
  20:	83 eb 01             	sub    $0x1,%ebx
  23:	74 2f                	je     54 <main+0x54>
        pid[i] = fork();
  25:	e8 b0 02 00 00       	call   2da <fork>
        if(pid[i] == 0) {
  2a:	85 c0                	test   %eax,%eax
  2c:	75 f2                	jne    20 <main+0x20>
  2e:	bb 80 96 98 00       	mov    $0x989680,%ebx
  33:	90                   	nop
  34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            for(int j=0;j<10000000;j++) {
                printf(1,"");
  38:	83 ec 08             	sub    $0x8,%esp
  3b:	68 e2 07 00 00       	push   $0x7e2
  40:	6a 01                	push   $0x1
  42:	e8 09 04 00 00       	call   450 <printf>
            for(int j=0;j<10000000;j++) {
  ...
  4d:	75 e9                	jne    38 <main+0x38>
            ...
            exit();
  4f:	e8 8e 02 00 00       	call   2e2 <exit>
  54:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  57:	8d 75 e0             	lea    -0x20(%ebp),%esi
  5a:	bb 19 00 00 00       	mov    $0x19,%ebx
  5f:	90                   	nop
        }
    }
    for(int i=0;i<25;i++) {
  ...
  63:	57                   	push   %edi
  64:	56                   	push   %esi
  65:	e8 18 03 00 00       	call   382 <waitx>
  ...
  81:	83 eb 01             	sub    $0x1,%ebx
  84:	75 da                	jne    60 <main+0x60>
  86:	eb c7                	jmp    4f <main+0x4f>
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
