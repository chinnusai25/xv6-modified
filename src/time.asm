...
int main (int argc,char *argv[])
{
  ...
  12:	8b 59 04             	mov    0x4(%ecx),%ebx
	...
	pid = fork();
  15:	e8 b0 02 00 00       	call   2ca <fork>
	if (pid == 0)
  1a:	85 c0                	test   %eax,%eax
  1c:	75 41                	jne    5f <main+0x5f>
  	{	
  		exec(argv[1], argv);
  1e:	52                   	push   %edx
  1f:	52                   	push   %edx
  ...
  24:	e8 e1 02 00 00       	call   30a <exec>
    	printf(1, "exec %s failed\n", argv[1]);
  29:	83 c4 0c             	add    $0xc,%esp
  2c:	ff 73 04             	pushl  0x4(%ebx)
  2f:	68 98 07 00 00       	push   $0x798
  34:	6a 01                	push   $0x1
  36:	e8 05 04 00 00       	call   440 <printf>
  ...
  5f:	50                   	push   %eax
  60:	50                   	push   %eax
  61:	8d 45 f4             	lea    -0xc(%ebp),%eax
  64:	50                   	push   %eax
  65:	8d 45 f0             	lea    -0x10(%ebp),%eax
  68:	50                   	push   %eax
  69:	e8 04 03 00 00       	call   372 <waitx>
  6e:	83 c4 10             	add    $0x10,%esp
  71:	eb ce                	jmp    41 <main+0x41>
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb e0 07 00 00       	mov    $0x7e0,%ebx
        while(*s != 0){
