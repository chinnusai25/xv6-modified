...
_process_creator:     file format elf32-i386
  ...
  13:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  if(argc < 2 )
  19:	0f 8f 86 00 00 00    	jg     a5 <main+0xa5>
    n = 1;       //default value
  1f:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
  ...
  id = 0;
  printf("%d\n",&n );
  26:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  29:	83 ec 08             	sub    $0x8,%esp
  2c:	50                   	push   %eax
  2d:	68 46 08 00 00       	push   $0x846
  32:	e8 89 04 00 00       	call   4c0 <printf>
  for ( k = 0; k < n; k++ ) {
  37:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	85 c9                	test   %ecx,%ecx
  3f:	7e 5f                	jle    a0 <main+0xa0>
  41:	31 db                	xor    %ebx,%ebx
  43:	eb 28                	jmp    6d <main+0x6d>
  45:	8d 76 00             	lea    0x0(%esi),%esi
    id = fork ();
    if ( id < 0 ) {
      printf(1, "%d failed in fork!\n", getpid() );
    } else if ( id > 0 ) {  //parent
  48:	74 71                	je     bb <main+0xbb>
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  4a:	e8 83 03 00 00       	call   3d2 <getpid>
  4f:	56                   	push   %esi
  50:	50                   	push   %eax
  for ( k = 0; k < n; k++ ) {
  51:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  54:	68 2c 08 00 00       	push   $0x82c
  59:	6a 01                	push   $0x1
  5b:	e8 60 04 00 00       	call   4c0 <printf>
     wait ();
  60:	e8 f5 02 00 00       	call   35a <wait>
  65:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  68:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
  6b:	7e 33                	jle    a0 <main+0xa0>
    id = fork ();
  6d:	e8 d8 02 00 00       	call   34a <fork>
    if ( id < 0 ) {
  72:	85 c0                	test   %eax,%eax
    id = fork ();
  74:	89 c6                	mov    %eax,%esi
    if ( id < 0 ) {
  76:	79 d0                	jns    48 <main+0x48>
      printf(1, "%d failed in fork!\n", getpid() );
  78:	e8 55 03 00 00       	call   3d2 <getpid>
  7d:	83 ec 04             	sub    $0x4,%esp
  for ( k = 0; k < n; k++ ) {
  80:	83 c3 01             	add    $0x1,%ebx
      printf(1, "%d failed in fork!\n", getpid() );
  83:	50                   	push   %eax
  84:	68 18 08 00 00       	push   $0x818
  89:	6a 01                	push   $0x1
  8b:	e8 30 04 00 00       	call   4c0 <printf>
  90:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  93:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
  96:	7f d5                	jg     6d <main+0x6d>
  98:	90                   	nop
  ...
  a8:	ff 70 04             	pushl  0x4(%eax)
  ab:	e8 30 02 00 00       	call   2e0 <atoi>
  b0:	83 c4 10             	add    $0x10,%esp
  b3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  b6:	e9 6b ff ff ff       	jmp    26 <main+0x26>
      printf(1, "Child %d created\n",getpid() );
  bb:	e8 12 03 00 00       	call   3d2 <getpid>
  c0:	52                   	push   %edx
  c1:	50                   	push   %eax
  ...
  d0:	83 c4 10             	add    $0x10,%esp
      for ( z = 0; z < 8000000.0; z += 0.01 )
  d3:	dd 05 60 08 00 00    	fldl   0x860
  d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  e0:	dc c1                	fadd   %st,%st(1)
  e2:	d9 05 68 08 00 00    	flds   0x868
  e8:	df ea                	fucomip %st(2),%st
  ea:	77 f4                	ja     e0 <main+0xe0>
  ec:	dd d8                	fstp   %st(0)
  ee:	dd d8                	fstp   %st(0)
  f0:	eb ae                	jmp    a0 <main+0xa0>
  f2:	66 90                	xchg   %ax,%ax
  f4:	66 90                	xchg   %ax,%ax
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb 6c 08 00 00       	mov    $0x86c,%ebx
        while(*s != 0){
