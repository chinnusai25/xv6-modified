...
_pr_create:     file format elf32-i386
  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  af:	e8 ec 03 00 00       	call   4a0 <printf>
      for ( z = 0; z < 9543000.0; z += 0.01 )
  b4:	d9 ee                	fldz   
      printf(1, "Child %d created\n",getpid() );
  b6:	83 c4 10             	add    $0x10,%esp
      for ( z = 0; z < 9543000.0; z += 0.01 )
  b9:	dd 05 40 08 00 00    	fldl   0x840
  bf:	90                   	nop
  c0:	dc c1                	fadd   %st,%st(1)
  c2:	d9 05 48 08 00 00    	flds   0x848
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 4c 08 00 00       	mov    $0x84c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 04 0b 00 00    	mov    0xb04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 04 0b 00 00    	cmp    %eax,0xb04
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 04 0b 00 00 08 	movl   $0xb08,0xb04
 7c7:	0b 00 00 
 7ca:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 7d1:	0b 00 00 
    base.s.size = 0;
 7d4:	b8 08 0b 00 00       	mov    $0xb08,%eax
 7d9:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 7e0:	00 00 00 
