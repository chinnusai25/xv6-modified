...
_set_pr:     file format elf32-i386
  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  if(argc < 3 ){
  19:	7f 05                	jg     20 <main+0x20>
      exit();
  1b:	e8 92 02 00 00       	call   2b2 <exit>
  }
  pid = atoi ( argv[1] );
  20:	83 ec 0c             	sub    $0xc,%esp
  23:	ff 73 04             	pushl  0x4(%ebx)
  26:	e8 15 02 00 00       	call   240 <atoi>
  ...
  39:	83 f8 64             	cmp    $0x64,%eax
  3c:	76 13                	jbe    51 <main+0x51>
      printf(2, "Invalid priority (0-100)!\n" );
  3e:	51                   	push   %ecx
  3f:	51                   	push   %ecx
  40:	68 78 07 00 00       	push   $0x778
  45:	6a 02                	push   $0x2
  47:	e8 d4 03 00 00       	call   420 <printf>
      exit();
  4c:	e8 61 02 00 00       	call   2b2 <exit>
  }
  ...
  53:	50                   	push   %eax
  54:	56                   	push   %esi
  55:	e8 10 03 00 00       	call   36a <set_priority>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 93 07 00 00       	mov    $0x793,%ebx
        while(*s != 0){
